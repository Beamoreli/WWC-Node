...
//     }
//     if (count = 2) {
//         console.log("Este numero e primo, e so pode ser dividido por 1 e por ele mesmo")
//     }
// }
...
function rodarAplicacao() {
    ...
    do {
        ...
        var continuar = String(readline.question("\n Deseja verificar outro numero? Responda S para sim ou N para nao: "));
    } while (continuar == 'S');
